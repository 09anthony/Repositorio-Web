<%-- 
    Document   : Autores
    Created on : 15/11/2018, 02:01:58 AM
    Author     : Blustin
--%>
...
<html>
    ...
    <body>
        <div class="panel panel-success">
            <div class="panel-heading"><center><h2>Fecha de Publicación</h2></center></div>
          <div class="panel-body">
              <form class="navbar-form navbar-left" action="" style="margin-left: 43%">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Ingrese Fecha, Mes y/o Dia" name="txt1">
...
<%}
                            ...
                            ArrayList<PdfVO> listar = emp.Listare_PdfVO(nom);
