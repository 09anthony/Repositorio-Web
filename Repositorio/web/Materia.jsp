<%-- 
    Document   : Materia
    Created on : 16/11/2018, 01:05:31 PM
...
<html>
    ...
    <body>
        ...
        <div class="panel panel-success">
            <div class="panel-heading"><center><h2>Listar por tema</h2></center></div>
          <div class="panel-body">
              <form class="navbar-form navbar-left" action="" style="margin-left: 43%">
                    <div class="input-group">
                        
                        <input type="text" class="form-control" placeholder="Nombre de Autor" name="txt1">
            ...
            <tr>
                <td><label style=" color: #0000cc"><center>Codigos</center></label></td>
                <td><label style=" color: #0000cc"><center>Nombre</center></label></td>
                <td><label style=" color: #0000cc"><center>Autor</center></label></td>
                <td><label style=" color: #0000cc"><center>Materia</center></label></td>
            ...
            <tr>
                ...
                <%}
                            ...
                            ArrayList<PdfVO> listar = emp.Listarb_PdfVO(nom);
