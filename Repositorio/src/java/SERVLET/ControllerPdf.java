...
public class ControllerPdf extends HttpServlet {
    ...
    public static final String lIST_STUDENT = "/Materia.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        sql auto = new sql();
        int nuevoid = auto.auto_increm("SELECT MAX(cod_lib) FROM libro;");
        ...
        RequestDispatcher view = request.getRequestDispatcher("/Materia.jsp");
        view.forward(request, response);
    }
